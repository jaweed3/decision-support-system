...
\midrule
1 & [Laptop A - isi dari data] & 0.847 \\
2 & [Laptop B - isi dari data] & 0.821 \\
3 & [Laptop C - isi dari data] & 0.798 \\
4 & [Laptop D - isi dari data] & 0.775 \\
5 & [Laptop E - isi dari data] & 0.761 \\
\bottomrule
\end{tabular}
\end{table}
...
\bibitem{kaggle2023}
Kaggle, ``Laptop Price Dataset,'' 2023. [Online]. Tersedia: \url{https://www.kaggle.com/datasets/} [Diakses: \today].
